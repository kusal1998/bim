                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="tbl">
                                ...
                                <tr>
                                        ...
                                        <td>DE</td>
                                           <td>xyzaaaa</td>
                                        <td>Assistan Commisioner</td>
                                        <td>
                                                <!--<a href="/14th-sentence/update/1" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>-->
                                                <a href="/14th-sentence/view/1" class="btn btn-icon btn-info"><i class="fas fa-eye"></i></a>
                                                <!-- <a href="javascript:;" data-toggle="modal" onclick="deleteData('.$Modules->id.')" -->
