...
<div class="content content-fixed">
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        ...
        <h5 id="section1" class="mg-b-10 text-center"><u>{{$fdate}} {{trans('sentence.to_date')}} {{$tdate}} {{trans('sentence.no_of_blocks_sent_to_main_office')}}</u> </h5>
  ...
  $(function () {
    $("#download").click(function () {
      ...
      else
      {
        ...
        window.open('/report6/export/'+ $("#startDate2").val() +'/'+ $("#startDate").val(),'_blank');
      }
    });
});
</script>
