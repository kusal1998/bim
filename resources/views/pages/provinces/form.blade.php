                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input @if(Request::segment(2)=='view' ) readonly @endif
                                        type="text"
                                        class="form-control" name="province_name" @if(isset($element))
                                        value="{{ old('province_name', $element->province_name) }}" @else value="{{ old('province_name') }}" @endif
                                        placeholder="Province Code">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="name">Provincial Code</label>
                                    <input @if(Request::segment(2)=='view' ) readonly @endif
                                        type="text"
                                        class="form-control" name="provincial_code" @if(isset($element))
                                        value="{{ old('provincial_code', $element->provincial_code) }}" @else
                                        value="{{ old('provincial_code') }}" @endif placeholder="Provincial Code">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
