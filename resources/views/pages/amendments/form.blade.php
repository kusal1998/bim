                    ...
                    <form method="post" @if(Request::segment(2)=='create' ) action="{{ route($url.'-store') }}" @else
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" required autocomplete="off" class="form-control" name="village" id="village" value="" placeholder="">
                            </div>
                            <div class="form-group col-md-3">
                ...
                $.ajax({url:urlseg1+'/'+$("#map_no").val()+'/'+$("#block_no").val()+'/'+$('#lot_no').val(),type:'get', success: function(response) {
                    if(response){
                        ...
                        }else
                        {
                            ...
                            var villages = '';
                            for(k=0;k<response.village.length;k++){
                                if(lan=='EN')
                                {
                                    if(k==0){
                                        villages = response.village[k]['village'];

                                    }else{
                                        villages = villages +','+ response.village[k]['village'];
                                ...
                                {
                                    if(k==0){
                                     villages = response.village[k]['sinhala_name']
                                    }else{
                                        villages = villages +',' + response.village[k]['sinhala_name']
                                    }

                                }
                             }
                            $('#village').val(villages);
