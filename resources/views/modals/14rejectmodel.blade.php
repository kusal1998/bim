...
<div class="modal fade" id="RejectModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel5" aria-hidden="true">
        ...
        <form action="{{url('/14th-sentence/update/'.$item->id)}}" method="POST" id="reject_form">
            @csrf
            <input type="hidden" name="from" value="detail_reject"/>
